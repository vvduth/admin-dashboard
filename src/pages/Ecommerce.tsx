...
const Ecommerce = () => {
  const {currentColor}  = useStateContext() as AppContextInterface
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div
          className="bg-white dark:text-gray-800 dark:bg-secondary-dark-bg 
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$1,440.021</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
        ...
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
          {earningData.map((item: EarningsDataItem, i: number) => (
            <div
              key={item.title}
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780  ">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">$12,123</span>
                </p>
